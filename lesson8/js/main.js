...
button0.position.set(15, 15, 4); // Position of the button in 3D space
scene.add(button0);
...
button1.position.set(65, 15, -25); // Position of the button in 3D space
scene.add(button1);
...
button10.position.set(18, 15, -30);
scene.add(button10);
//*************************************************************************************/
...
const text0Material = new THREE.MeshBasicMaterial({
    map: createTextTexture("أنشاء فريق ", "white", fontn),
    transparent: true,
});
...
text0Plane.position.set(15, 17, 4); // Position above Button 1
scene.add(text0Plane);

// Add text to Button 1
const text1Material = new THREE.MeshBasicMaterial({
    map: createTextTexture("تبويب الفريق ", "white", fontn),
    transparent: true,
});
...
text1Plane.position.set(65, 17, -25); // Position above Button 1
scene.add(text1Plane);

// Add text to Button 2
const text2Material = new THREE.MeshBasicMaterial({
    map: createTextTexture("أنشاء الفريق ", "white", fontn),
    transparent: true,
});
...
text2Plane.position.set(65, 17, -10); // Position above Button 2
scene.add(text2Plane);

// Add text to Button 3
const text3Material = new THREE.MeshBasicMaterial({
    map: createTextTexture("أعدادت الفريق ", "white", fontn),
    transparent: true,
});
...
const text4Material = new THREE.MeshBasicMaterial({
    map: createTextTexture("الأشعارات الخاصة  ", "white", fontn),
    transparent: true,
});
...
text4Plane.position.set(65, 17, 32); // Position above Button 2
scene.add(text4Plane);

// Add text to Button 5
const text5Material = new THREE.MeshBasicMaterial({
    map: createTextTexture("حذف الفريق ", "white", fontn),
    transparent: true,
});
...
text5Plane.position.set(20, 17, 35); // Position above Button 2
scene.add(text5Plane);

// Add text to Button 6
const text6Material = new THREE.MeshBasicMaterial({
    map: createTextTexture("أعدادات القناة ", "white", fontn),
    transparent: true,
});
...
text6Plane.position.set(-55, 17, 32); // Position above Button 2
scene.add(text6Plane);

// Add text to Button 7
const text7Material = new THREE.MeshBasicMaterial({
    map: createTextTexture("البوست", "white", fontn),
    transparent: true,
});
...
text7Plane.position.set(-55, 17, 12); // Position above Button 2
scene.add(text7Plane);

// Add text to Button 8
const text8Material = new THREE.MeshBasicMaterial({
    map: createTextTexture(" الملحظات ", "white", fontn),
    transparent: true,
});
...
text8Plane.position.set(-55, 17, -12); // Position above Button 2
scene.add(text8Plane);

// Add text to Button 9
const text9Material = new THREE.MeshBasicMaterial({
    map: createTextTexture(" أنواع الواجبات ", "white", fontn),
    transparent: true,
});
...
text9Plane.position.set(-55, 17, -30); // Position above Button 2
scene.add(text9Plane);

// Add text to Button 10
const text10Material = new THREE.MeshBasicMaterial({
    map: createTextTexture(" الدرجات ", "white", fontn),
    transparent: true,
});
...
text10Plane.position.set(18, 17, -30); // Position above Button 2
