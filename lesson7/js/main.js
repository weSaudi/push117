...
button0.position.set(8, 15, -1); // Position of the button in 3D space
scene.add(button0);
...
button1.position.set(45, 15, -25); // Position of the button in 3D space
scene.add(button1);
...
const text0Material = new THREE.MeshBasicMaterial({
    map: createTextTexture("البرامج الملحقة", "white", fontn),
    transparent: true,
});
...
text0Plane.position.set(4, 17, 0); // Position above Button 1
scene.add(text0Plane);

// Add text to Button 1
const text1Material = new THREE.MeshBasicMaterial({
    map: createTextTexture("الأنشطة ", "white", fontn),
    transparent: true,
});
...
text1Plane.position.set(45, 17, -25); // Position above Button 1
scene.add(text1Plane);

// Add text to Button 2
const text2Material = new THREE.MeshBasicMaterial({
    map: createTextTexture("المحادثات ", "white", fontn),
    transparent: true,
});
...
text2Plane.position.set(40, 17, 13); // Position above Button 2
scene.add(text2Plane);

// Add text to Button 3
const text3Material = new THREE.MeshBasicMaterial({
    map: createTextTexture(" خاصية البحث ", "white", fontn),
    transparent: true,
});
...
text3Plane.position.set(1, 17, 38); // Position above Button 2
scene.add(text3Plane);

// Add text to Button 4
const text4Material = new THREE.MeshBasicMaterial({
    map: createTextTexture("أضافة الأصدقاء", "white", fontn),
    transparent: true,
});
...
text4Plane.position.set(-60, 17, -13); // Position above Button 2
...
text5Plane.position.set(-55, 17, 19); // Position above Button 2
scene.add(text5Plane);

// Add text to Button 6
const text6Material = new THREE.MeshBasicMaterial({
    map: createTextTexture("أضافة الروابط ", "white", fontn),
    transparent: true,
});
...
text6Plane.position.set(7, 17, -35); // Position above Button 2
